...
public static class RemoveMedievalStuffHarmony
{
    ...
    {
        return !ModStuff.Settings.LimitFactions || facDef is not { techLevel: > RemoveMedievalStuff.MAX_TECHLEVEL };
    }

    public static void ItemCollectionGeneratorGeneratePrefix(ref ThingSetMakerParams parms)
    {
        if (parms.techLevel is null or > RemoveMedievalStuff.MAX_TECHLEVEL)
        {
